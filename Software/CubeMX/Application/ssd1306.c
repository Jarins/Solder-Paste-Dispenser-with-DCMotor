...
#define SSD1306_MULTIPLE_DATA 	0xC0
#define SSD1306_COMMAND   		0x00
/* Write command */
#define SSD1306_WRITECOMMAND(command)      ssd1306_I2C_Write(SSD1306_I2C_ADDR, SSD1306_COMMAND, (command))
/* Write data */
#define SSD1306_WRITEDATA(data)            ssd1306_I2C_Write(SSD1306_I2C_ADDR, SSD1306_DATA, (data))
/* Absolute value */
...
#define SSD1306_MIRROR_HORIZ		 					0xA0// Mirror horizontally
#define SSD1306_MIRROR_HORIZ_NORMAL	 					0xA1//--set segment re-map 0 to 127 - CHECK
#define SSD1306_MIRROR_VERT         					0xC0// Mirror vertically
#define SSD1306_MIRROR_VERT_NORM    					0xC8//Set COM Output Scan Direction
...
void SSD1306_MirrorVertically (int i)
{
  if (i) SSD1306_WRITECOMMAND (SSD1306_MIRROR_VERT);

  else SSD1306_WRITECOMMAND (SSD1306_MIRROR_VERT_NORM);

}

void SSD1306_MirrorHorizontally (int i)
{
  if (i) SSD1306_WRITECOMMAND (SSD1306_MIRROR_HORIZ);

  else SSD1306_WRITECOMMAND (SSD1306_MIRROR_HORIZ_NORMAL);
...
#else
	SSD1306_WRITECOMMAND(0x12);							// 0x12 is for 128x64 !!!!!!!!!!!!!! UPDATE IN HEADER
#endif
...
void SSD1306_DrawRectangle(uint16_t x, uint16_t y, uint16_t w, uint16_t h, SSD1306_COLOR_t c) {
	...
	if (x >= SSD1306_WIDTH || y >= SSD1306_HEIGHT)	return;/* Return error */
